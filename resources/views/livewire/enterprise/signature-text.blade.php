<!-- Text-based Email Signature Template - Maximum Gmail compatibility -->
<table cellpadding="0" cellspacing="0" border="0" style="background:#ffffff; border-radius:8px; box-shadow:0 2px 8px #eeeeee; padding:20px; width:350px; font-family:Arial, Helvetica, sans-serif; font-size:14px;">
    <tr>
        ...
        <td style="vertical-align:top; text-align:center; width:130px;">
            ...
            <div style="width:90px; height:90px; display:inline-block; position:relative; background:#f8f9fa; border:1px solid #eeeeee; border-radius:6px; display:flex; align-items:center; justify-content:center;">
                <div style="text-align:center; color:#007bff; font-size:11px; font-weight:bold;">
                    📱<br>Scan to<br>Connect
                </div>
            </div>
